        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @foreach($riwayat as $riwayat)
                        <div class="card justify-content-center iq-mtb-15 d-flex border-0"style=" margin-left:5%; margin-right:3%; padding-left:1%; padding-right:1%; min-width:20%; max-width: 100%; max-height:100%">
