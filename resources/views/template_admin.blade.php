    ...
    {{-- <div class="container-fluid"> --}}
      <div class="row flex-nowrap g-0">
          <div id="sidebar" class="col-auto col-md-3 col-xl-2 px-sm-2 px-0">
              <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                  <a href="/" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                      <span style="font-family: 'Montserrat', sans-serif;color: #3587A2" class="fs-5 d-none d-sm-inline">Go Telaga Sarangan</span>
                  </a>
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="/admin/tiket" class="nav-link px-0 align-middle">
                          <i class="material-icons">check_box</i> <span id="side_item" class="ms-1 d-none d-sm-inline">Tiket</span></a>
                    </li>
                    ...
                    <li>
                      ...
                      <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                          <li class="w-100">
                              <a href="/admin/umkm_admin" class="nav-link px-0"> <span id="side_item" style="color: #808080" class="d-none d-sm-inline">Jenis UMKM</span>  </a>
                          </li>
                          <li>
                              <a href="/admin/item_umkm_admin" class="nav-link px-0"> <span id="side_item" style="color: #808080" class="d-none d-sm-inline">List UMKM</span> </a>
                          </li>
                      </ul>
                  </li>
          ...
          <div  class="col">
            ...
            <nav id="bar" class="navbar navbar-light">
              <div class="container-fluid">
                <a class="navbar-brand" style="visibility: hidden" href="#">Navbar</a>
             <div class="row flex-nowrap g-0">
              <div class="col">
                <img src="https://github.com/mdo.png" alt="hugenerd" width="30" height="30" class="rounded-circle mt-2">
              </div>
              <div class="col">
                Fathul Nisa
              </div>
