            ...
            <div class="row align-items-start">
                <div class="col-md-3">              
                    ...
                    <a style="text-decoration: none;" href="#">
                        ...
                        <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                            ...
                            <div class="card-body">
                              <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Jenang Candi</p>
                ...
                {{-- start --}}
                    <a style="text-decoration: none;" href="#">
                        ...
                        <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                            <img src="{!! asset('images/image 8.jpg') !!}" class="card-img-top" alt="UMKM Sayur">
                            <div class="card-body">
                              <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Emping</p>
                              <a style="color:#167594">Harga rata - rata: </a>
                ...
                <div class="col-md-3">
                   ...
                   <a style="text-decoration: none;" href="#">
                    ...
                    <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                        <img src="{!! asset('images/image 6.png') !!}" class="card-img-top" alt="UMKM Kuliner">
                        <div class="card-body">
                          <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Bolu Rahayu</p>
                          <a style="color:#167594">Harga rata - rata: </a>
                              <p style="color:#167594">Rp. 15.000 </p>
                              <button type="button" style=" padding-left: 10%;padding-right: 10%;" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modalPesan">Detai Produk</button>
                        </div>
                ...
                {{-- end --}}
                 ...
                 <div class="col-md-3">
                   ...
                   <a style="text-decoration: none;" href="#">
                    ...
                    <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                        <img src="{!! asset('images/image 7.png') !!}" class="card-img-top" alt="UMKM Fashion">
                        <div class="card-body">
                          <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Jadah</p>
                          <a style="color:#167594">Harga rata - rata: </a>
                ...
                <div class="col-md-3">
                    ...
                    <a style="text-decoration: none;" href="#">
                     ...
                     <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                         <img src="{!! asset('images/image 9.png') !!}" class="card-img-top" alt="UMKM Cendramata">
                         <div class="card-body">
                           <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Madu Mongso</p>
                           <a style="color:#167594">Harga rata - rata: </a>
                              <p style="color:#167594">Rp. 10.000 </p>
                              <button type="button" style=" padding-left: 10%;padding-right: 10%;" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modalPesan">Detai Produk</button>
                         </div>
                 ...
                 <div class="col-md-3">
                    ...
                    <a style="text-decoration: none;" href="#">
                     ...
                     <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                         <img src="{!! asset('images/image 12.jpg') !!}" class="card-img-top" alt="UMKM Tanaman">
                         <div class="card-body">
                           <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Lempeng</p>
                           <a style="color:#167594">Harga rata - rata: </a>
                              <p style="color:#167594">Rp. 10.000 </p>
                              <button type="button" style=" padding-left: 10%;padding-right: 10%;" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modalPesan">Detai Produk</button>
                         </div>
                 ...
                 <div class="col-md-3">
                    ...
                    <a style="text-decoration: none;" href="#">
                     ...
                     <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                         <img src="{!! asset('images/image 10.png') !!}" class="card-img-top" alt="UMKM Tanaman">
                         <div class="card-body">
                           <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Jerangking</p>
                           <a style="color:#167594">Harga rata - rata: </a>
                              <p style="color:#167594">Rp. 10.000 </p>
                              <button type="button" style=" padding-left: 10%;padding-right: 10%;" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modalPesan">Detai Produk</button>
                         </div>
                 ...
                 <div class="col-md-3">
                    ...
                    <a style="text-decoration: none;" href="#">
                     ...
                     <div class="card rounded-3" style="width: 16rem; height: 20rem; padding: 10%">
                         <img src="{!! asset('images/image 11.png') !!}" class="card-img-top" alt="UMKM Tanaman">
                         <div class="card-body">
                           <p id="tittle_card"  style="color:#167594;margin-top: 4%" class="card-text">Sambel Pecel</p>
                           <a style="color:#167594">Harga rata - rata: </a>
                              <p style="color:#167594">Rp. 10.000 </p>
                              <button type="button" style=" padding-left: 10%;padding-right: 10%;" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modalPesan">Detai Produk</button>
                         </div>
